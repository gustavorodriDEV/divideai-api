package com.gustavo.divideai_api.services;

import com.gustavo.divideai_api.dtos.ParticipanteDTO;
import com.gustavo.divideai_api.entities.Grupo;
import com.gustavo.divideai_api.entities.Participante;
import com.gustavo.divideai_api.repositories.ParticipanteRepository;
import com.gustavo.divideai_api.services.exceptions.RecursoNaoEncontradoException;
...
public class ParticipanteService {
    ...
    public Participante buscarParticipante(Long idParticipante) {
        return participanteRepository.findById(idParticipante)
                .orElseThrow(() -> new RecursoNaoEncontradoException("Participante não encontrado com o ID: " + idParticipante));
    }
    ...
    public void deletarParticipante(Long idParticipante) {
        if (!participanteRepository.existsById(idParticipante)) {
            throw new RecursoNaoEncontradoException("Participante não encontrado com o ID: " + idParticipante);
        }
